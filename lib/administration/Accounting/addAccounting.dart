...
class _AddAccountingState extends State<AddAccounting> {
  ...
  addAccountingData() {
    if (formKey.currentState.validate()) {
      ...
      _secondDateController.clear();
      enterValidDay.clear();
      _enterInterestCharge.clear();
      _enterFixCharge.clear();
      _mandatoryController.clear();
    }
  }
